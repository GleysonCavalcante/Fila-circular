...
})({"aVs5V":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 63201;
...
var _filacircular = require("./filacircular");
const fila = new (0, _filacircular.FilaCircular)(5);
fila.inserir(10);
fila.inserir(20);
fila.inserir(30);
...
fila.inserir(40);
fila.inserir(50);
console.log("Fila depois das inser\xe7\xf5es:");
fila.exibir();

},{"./filacircular":"8BQmv"}],"8BQmv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FilaCircular", ()=>FilaCircular);
class FilaCircular {
    constructor(tamanho){
    ...
    inserir(valor) {
        if (this.qtd === this.capacidade) {
            console.log("A fila est\xe1 cheia!");
            return;
        }
    ...
    remover() {
        if (this.qtd === 0) {
            console.log("A fila est\xe1 vazia!");
            return null;
        }
...
},{}]},["aVs5V","eGa6Y"], "eGa6Y", "parcelRequire6382", {})
